...
void weapon::operator+( weapon &x ) // tworzenie nowego obiektu wybierając lepsze elemnty z 2 broni
{
    ...
    Menu::weapon_tab.add_last(Menu::pom);
...
void weapon::test_K()
{
    ...
    assert(Menu::weapon_tab.show_size()==1);
...
//  Konstruktor v2
    ...
    assert(Menu::weapon_tab.show_size()==2);
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    //// konstruktor v3

    Menu::pom= new weapon(  200,  300,  56,  60, 600 ,  "Ak", 1, 30, "standardowy", 1 ,1 ,1 ,1 );
    ...
    assert(Menu::weapon_tab.show_size()==3);
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    assert(Menu::weapon_tab.show_size()==4);
...
//////// Test operatorów
 void weapon::test_O()
 {
     *(Menu::weapon_tab[2])+*(Menu::weapon_tab[3]);
        ...
        assert(Menu::weapon_tab.show_size()==5);
