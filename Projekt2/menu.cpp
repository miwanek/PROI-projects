...
/*! \file */
    ...
    New_vector<weapon*> Menu::weapon_tab; //wektor przetrzymujący wskazniki na bronie
 weapon* Menu::pom;
...
void Menu::Mainmenu()
{
    ...
    clean(); // funkcja czyszcząca
        ...
        case '1':
            ...
            for(unsigned int i=0;i<Menu::weapon_tab.show_size();i++) // przeszukujemy od 0 do rozmiaru wketora-1
            {
        ...
        case '2':
            ...
            clean();
                for(unsigned int i=0; i<Menu::weapon_tab.show_size(); i++)
                {
                           ...
                           do
                           {
                            ...
                            switch(akcja)
                            {
                                ...
                                case '2':
                                    ...
                                    Menu::weapon_tab.dispose( weapon_nr); //usuwamy broń z wektora i pamięci
...
void Menu::add()
{
    ...
    {
        pom= new weapon(  range1,  weight1,  caliber1,   accuracy1,
                 firerate1,  name1,  full_auto1, 30 , "standardowy",
                  silencer_allowed1,  tripod_allowed1,  tripod1,  silencer1);
    }
    ...
    weapon_tab.add_last(pom); //dodajemy broń na wektor
